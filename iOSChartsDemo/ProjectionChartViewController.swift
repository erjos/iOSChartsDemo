...
//        }
    ...
    func generateSplitBand() -> Band{
        ...
        //NOTE: need to pull down the latest changes to the android version and see what changes were made to the projection Interactor and projection model
        //need to prevent this from throwing an index out of range if the band is already the highest or lowest band
        //the latest changes should also incorporate comprehensive checks to ensure that we are handling the data correctly for all cases
