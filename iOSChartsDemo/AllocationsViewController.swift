...
class AllocationsViewController: UIViewController {
    ...
    //These are the colors I pulled out of the spec
    ...
    func setAllocationsChart(portfolioBreakdown: PortfolioBreakdown){
        ...
        //The following logic is used to construct the array of NSUicolors that will be displayed by the chart
...
//            }
        ...
        //Generate PieChartDataEntries for each of the positions in the list -> this is what will be changed when the tabs switch
